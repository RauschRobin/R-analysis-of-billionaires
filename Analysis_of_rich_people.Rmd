...
This plot makes no sense and will therefore not be interpreted by its context. TODO: PLEASE REMOVE RANK, THE CORRELATION BETWEEN FINALWORTH AND RANK IS OBVIOUS AND SHOULD NOT BE HIGHLIGHTED!
...
ggmap(world_map) +
  geom_point(data = df, aes(x = longitude_country, y = latitude_country, color = finalWorth, size = finalWorth), alpha = 0.7) +
  scale_color_viridis_c() +
  labs(title = "Geographical Distribution of Billionaires",
       x = "Longitude",
       y = "Latitude",
       color = "Final Net Worth",
       size = "Final Net Worth") +
  theme_void()
```
...
Generally men are richer than women. TODO: PLEASE ZOOM ON BOXPLOT AND FOCUS ON THESE STATS INSTEAD OF RICHEST 25%!
...
The most wealth lies in usa and china (glaube ich). Chinese billionaires are mostly self-made. In the U.S. roughly 1/3 inherited their wealth. TODO: WIE KANN ICH DAS BESSER DARSTELLEN? HAST DU EINE IDEE?
