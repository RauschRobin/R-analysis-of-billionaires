...
ggplot(df_billionaires, aes(x = finalWorth)) +
  ...
  labs(title = "Billionaire Wealth Distribution", x = "Final Worth", y = "Frequency") +
  theme_minimal()
```
...
The following bar chart shows the wealth distribution over all industries given in the data set. It also differentiates between self-made wealth and inherited wealth.
