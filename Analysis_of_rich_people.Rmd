...
primary_plot <- ggplot(df_temp.primary[1:10, ], aes(x = reorder(country, -primary_education), y = primary_education)) +
    geom_bar(stat = "identity") +
    labs(
...
tertiary_plot <- ggplot(df_temp.tertiary[1:10, ], aes(x = reorder(country, -tertiary_education), y = tertiary_education)) +
    geom_bar(stat = "identity") +
    labs(
